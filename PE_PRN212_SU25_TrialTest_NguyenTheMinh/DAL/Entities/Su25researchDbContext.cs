...
public partial class Su25researchDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ProjectId).HasName("PK__Research__761ABED0E31632E5");
        ...
        {
            entity.HasKey(e => e.ResearcherId).HasName("PK__Research__7CC06F055034B3D0");

            entity.ToTable("Researcher");

            entity.HasIndex(e => e.Email, "UQ__Research__A9D105341CCDC65D").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserAcco__1788CCAC84493B36");

            entity.ToTable("UserAccount");

            entity.HasIndex(e => e.Email, "UQ__UserAcco__A9D105346B721A68").IsUnique();
